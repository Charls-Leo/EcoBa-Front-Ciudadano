...
export class RutasPage implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.webSocketService.messages$
      ...
      .subscribe(msg => {
        console.log(`[RUTAS-CIUDADANO] 📡 Evento real-time '${msg.event}' recibido. Actualizando silenciosamente...`);
  ...
  /** Navega al mapa para ver la ruta (y si hay recorrido activo, con tracking) */
